...
$chapter_title = get_the_title(76);
$chapter_intro = get_post_field('post_content', 76);
$chapter_link = 'chapter-6';
$chapter_next = '';
$chapter_previous = 'chapter-5';
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-10 offset-md-1 col-xl-7 offset-xl-0 chapter-image text-center" data-content="<?php echo $chapter_link; ?>">
            <div class="placeholder">
                <img src="<?php bloginfo ('stylesheet_directory'); ?>/assets/images/06_champions.png" class="w-100" alt="temp image">
            </div>
